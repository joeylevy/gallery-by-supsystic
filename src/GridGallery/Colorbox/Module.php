 ...
 */
class GridGallery_Colorbox_Module extends Rsc_Mvc_Module
{
    ...
    protected function loadPlugin(GridGallery_Ui_Module $ui)
    {
        ...
        $frontend = new GridGallery_Ui_Javascript(
    ...
    protected function loadTheme(GridGallery_Ui_Module $ui)
    {
        ...
        $ui->add(
            new GridGallery_Ui_BackendStylesheet(
